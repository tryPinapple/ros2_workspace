...
class SubLQRSolver:
    ...
    * TARGET VELOCITY > 0 (Trajectory Tracking / Cruise Control):
    ...
    def update_system_dynamics_matrix_A(self, Am: np.ndarray, state: np.ndarray) -> np.ndarray:
        ...
        Am[6][0:4] = 0.0
        Am[6][4] = 0.026315789473684210526315789473684 * cos_pitch * (41092.031908954495559091375453296 * radius ** 3 - 274.68)
        Am[6][5] = 0.0
        Am[6][6] = 0.58447368421052631578947368421053 # Linear Drag (X)
        ...
        Am[7][0:3] = 0.0
        Am[7][3] = -0.026315789473684210526315789473684 * cos_pitch * cos_roll * (41092.031908954495559091375453296 * radius ** 3 - 274.68)
        Am[7][4] = 0.026315789473684210526315789473684 * sin_pitch * sin_roll * (41092.031908954495559091375453296 * radius ** 3 - 274.68)
        Am[7][5] = 0.0
        Am[7][6] = -1.0 * r
        Am[7][7] = 0.73368421052631578947368421052632 # Linear Drag (Y)
        Am[7][8] = p
        Am[7][9] = w
        Am[7][10] = 0.0
        Am[7][11] = -1.0 * u
        ...
        Am[8][0:3] = 0.0
        Am[8][3] = 0.026315789473684210526315789473684 * cos_pitch * sin_roll * (41092.031908954495559091375453296 * radius ** 3 - 274.68)
        Am[8][4] = 0.026315789473684210526315789473684 * cos_roll * sin_pitch * (41092.031908954495559091375453296 * radius ** 3 - 274.68)
        Am[8][5] = 0.0
        Am[8][6] = q
        Am[8][7] = -1.0 * p
        Am[8][8] = 1.1089473684210526315789473684211 # Linear Drag (Z)
        Am[8][9] = -1.0 * v
        Am[8][10] = u
        Am[8][11] = 0.0
        ...
        Am[9][0:9] = 0.0
        Am[9][9] = 3.4105263157894736842105263157895 # Rotational Drag (Roll)
        ...
        Am[10][0:9] = 0.0
        Am[10][9] = 0.75 * r
        Am[10][10] = 3.3157894736842105263157894736842 # Rotational Drag (Pitch)
        Am[10][11] = 0.75 * p
        ...
        Am[11][11] = 1.9252971137521222410865874363328 # Rotational Drag (Yaw)
